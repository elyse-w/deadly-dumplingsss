...
#define STRAIGHT_KP 0.8 // 1 //0.7
#define STRAIGHT_KI 0.1 // 0.001 //0.1
#define STRAIGHT_KD 7.90 // 1 //8
...
#define TURN_KP 5.25//5.25//8.75 //every 0.25 is 2 degrees
#define TURN_KI 0 //0.125//0.115
#define TURN_KD 57 //38 //105 //70
...
#define ARC_HEADING_KP 1 //5.25//8.75 //40 //40
#define ARC_HEADING_KI 0 //0.125//0.115
#define ARC_HEADING_KD 0 //38 //105 //70 //40
